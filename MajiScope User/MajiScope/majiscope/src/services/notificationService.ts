...
export async function registerPushToken(token: string, options?: { platform?: string; deviceName?: string; deviceId?: string; appRole?: string }): Promise<void> {
  try {
    await apiPost(getEndpointUrl('/api/push-tokens/register'), {
