...
"[project]/WEB-BASED/Frontend/app/(dashboard)/dashboard/dma-managers/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DMAManagersPage() {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$hooks$2f$use$2d$page$2d$access$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usePageAccess"])();
    ...
    const { dmaManagers, dmas, utilities, fetchDMAManagers, fetchDMAs, fetchUtilities, addDMAManager, updateDMAManager, deleteDMAManager } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$store$2f$data$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useDataStore"])();
    ...
    const [unassignId, setUnassignId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [formDMAId, setFormDMAId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("unassigned");
    ...
    async function handleSubmit() {
        ...
        if (!editingManager && !formPassword.trim()) {
            __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Password is required for new managers");
            return;
        }
        if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(formEmail)) {
            __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Invalid email format");
            return;
        }
        ...
        try {
            if (editingManager) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("DMA Manager updated successfully");
            } else {
                await addDMAManager({
                    name: formName,
                    email: formEmail,
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("DMA Manager created successfully");
            }
            setDialogOpen(false);
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error instanceof Error ? error.message : "Operation failed");
        }
    }
    async function handleDelete() {
        if (deleteId) {
            try {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("DMA Manager deleted successfully");
                setDeleteId(null);
            } catch (error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error instanceof Error ? error.message : "Failed to delete manager");
            }
        }
    }
    async function handleUnassignDMA() {
        if (unassignId) {
            try {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("DMA unassigned successfully");
                setUnassignId(null);
            } catch (error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error instanceof Error ? error.message : "Failed to unassign DMA");
            }
        }
    }
                                    ...
                                    children: filteredManagers.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableRow"], {
                                        ...
                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableRow"], {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableCell"], {
                                                    className: "py-4 px-6",
                                                    children: dma ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "flex items-center gap-2",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        availableDMAs.map((dma)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SelectItem"], {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    dma.managerId && dma.managerId === editingManager?.id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
//# sourceMappingURL=WEB-BASED_Frontend_6dd33736._.js.map