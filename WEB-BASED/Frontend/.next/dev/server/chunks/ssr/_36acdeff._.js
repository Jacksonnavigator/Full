...
"[project]/app/(dashboard)/_views/utility-infrastructure-page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getAssetFile(utility, assetType) {
    ...
    const layer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$data$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUtilityInfrastructureAsset"])(utility, assetType);
    return layer ? {
...
function UtilityInfrastructurePage() {
    ...
    const { utilities, fetchUtilities } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$data$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useDataStore"])();
    ...
    const [selectedAssetType, setSelectedAssetType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("pipe_network");
    ...
    const scopedUtilities = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
    ...
    async function handleUpload(event) {
        ...
        if (!file.name.toLowerCase().endsWith(".gpkg")) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Upload a single GeoPackage (.gpkg) file for infrastructure assets.");
        ...
        setBusyKey(busy);
        const toastId = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].loading(`Uploading ${asset.label.toLowerCase()} ...`);
        ...
        try {
            ...
            if (!response.ok) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(payload.detail || payload.error || `Failed to upload ${asset.label.toLowerCase()}`);
                return;
            }
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].dismiss(toastId);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(ready > 0 ? `${asset.label} uploaded with ${ready.toLocaleString()} previewable feature${ready === 1 ? "" : "s"}.` : `${asset.label} uploaded successfully.`);
            await fetchUtilities();
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].dismiss(toastId);
            console.error("Error uploading utility infrastructure:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(`Failed to upload ${asset.label.toLowerCase()}`);
        } finally{
            setBusyKey(null);
            setUploadTarget(null);
        }
    ...
    async function handleDownload(assetType) {
        ...
        setBusyKey(busy);
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].backend.baseUrl}${assetFile.downloadUrl}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
            if (!response.ok) {
                const payload = await response.json().catch(()=>({}));
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(payload.detail || payload.error || "Failed to download infrastructure file");
                return;
            }
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Failed to download infrastructure file");
        } finally{
            setBusyKey(null);
        }
    }
    async function handleRemove(assetType) {
        ...
        try {
            ...
            const payload = await response.json().catch(()=>({}));
            if (!response.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(payload.detail || payload.error || `Failed to remove ${asset.label.toLowerCase()}`);
                return;
            }
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(`${asset.label} removed successfully.`);
            await fetchUtilities();
        } catch (error) {
            console.error("Error removing utility infrastructure:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(`Failed to remove ${asset.label.toLowerCase()}`);
        } finally{
            setBusyKey(null);
        }
    }
...
//# sourceMappingURL=_36acdeff._.js.map