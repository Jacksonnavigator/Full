    ...
    async function fetchUserRecord() {
        ...
        try {
            ...
            if (currentUser.role === "utility_manager") {
                endpoint = `${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CONFIG"].backend.fullUrl}/utility-managers/${currentUser.id}`;
            } else if (currentUser.role === "dma_manager") {
                endpoint = `${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CONFIG"].backend.fullUrl}/dma-managers/${currentUser.id}`;
            } else if (currentUser.role === "admin") {
                endpoint = `${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CONFIG"].backend.fullUrl}/users/${currentUser.id}`;
            }
            if (!endpoint) {
                setLoading(false);
                return;
            ...
            if (response.ok) {
                ...
                const transformed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$transform$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["transformKeys"])(data);
...
//# sourceMappingURL=_bf297ddb._.js.map