...
"[project]/WEB-BASED/Frontend/app/(dashboard)/dashboard/team-leaders/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TeamLeadersPage() {
    ...
    const [viewingTeam, setViewingTeam] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [formLeaderId, setFormLeaderId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TeamLeadersPage.useEffect": ()=>{
            if (!isDMAManager || !dmaId) return;
            async function fetchData() {
                try {
                    setLoading(true);
                    // Fetch teams for this DMA
                    const teamsRes = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONFIG"].backend.fullUrl}/teams?dma_id=${dmaId}`, {
                        headers: {
                    ...
                    if (teamsRes.ok) {
                        ...
                        const transformedTeams = rawTeams.map({
                            "TeamLeadersPage.useEffect.fetchData.transformedTeams": (t)=>({
                                    id: t.id,
                                    name: t.name,
                        ...
                        }["TeamLeadersPage.useEffect.fetchData.transformedTeams"]);
                        setTeams(transformedTeams);
                    }
                    // Fetch engineers for this DMA
                    const engineersRes = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONFIG"].backend.fullUrl}/engineers?dma_id=${dmaId}`, {
                        headers: {
                            "Authorization": `Bearer ${localStorage.getItem('access_token')}`
                        }
                    });
                    if (engineersRes.ok) {
                        ...
                        const transformedEngineers = rawEngineers.map({
                            "TeamLeadersPage.useEffect.fetchData.transformedEngineers": (e)=>({
                                    id: e.id,
                                    name: e.name,
                                    email: e.email,
                                    phone: e.phone,
                        ...
                        }["TeamLeadersPage.useEffect.fetchData.transformedEngineers"]);
                        setEngineers(transformedEngineers);
                    }
                    // Fetch branches for this DMA
                    const branchesRes = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONFIG"].backend.fullUrl}/branches?dma_id=${dmaId}`, {
                        headers: {
                            "Authorization": `Bearer ${localStorage.getItem('access_token')}`
                        }
                    });
                    if (branchesRes.ok) {
                        ...
                        const transformedBranches = rawBranches.map({
                            "TeamLeadersPage.useEffect.fetchData.transformedBranches": (b)=>({
                                    id: b.id,
                                    name: b.name
                                })
                        }["TeamLeadersPage.useEffect.fetchData.transformedBranches"]);
    ...
    async function handleSubmit() {
        ...
        setSaving(true);
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONFIG"].backend.fullUrl}/teams/${editingTeam.id}/leader`, {
                method: "PUT",
                headers: {
                    "Authorization": `Bearer ${localStorage.getItem('access_token')}`,
            ...
            if (response.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Team leader updated successfully");
                setDialogOpen(false);
                // Refresh teams
                const teamsRes = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONFIG"].backend.fullUrl}/teams?dma_id=${dmaId}`, {
                    headers: {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.detail || error.error || "Failed to update team leader");
            }
        } catch (error) {
            console.error("Error updating team leader:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to update team leader");
        } finally{
            setSaving(false);
        }
    }
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableBody"], {
                                    children: filteredTeams.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                        ...
                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("border-b border-slate-100 transition-all duration-200", isInactive ? "bg-red-50/30 hover:bg-red-50/50" : "hover:bg-amber-50/50"),
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                    className: "py-4 px-6",
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("h-10 w-10 rounded-xl flex items-center justify-center shadow-lg", isInactive ? "bg-gradient-to-br from-red-400 to-rose-500" : "bg-gradient-to-br from-amber-500 to-orange-600"),
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$users$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Users$3e$__["Users"], {
                                                                    className: "h-5 w-5 text-white"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/WEB-BASED/Frontend/app/(dashboard)/dashboard/team-leaders/page.tsx",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Dialog"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogContent"], {
                    ...
                    children: [
                        ...
                        editingTeam && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectContent"], {
                                                    className: "rounded-xl shadow-lg shadow-slate-200/50",
                                                    children: availableLeaders.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        availableLeaders.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                currentLeader && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Dialog"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogContent"], {
                    ...
                    children: [
                        ...
                        viewingTeam && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                viewingTeam.description && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        ...
                                                        viewingTeam.leaderName ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            className: "text-sm font-medium text-slate-700",
...
_s(TeamLeadersPage, "jvRKEmFgKc+LXgz3QrV941O8YEo=", false, function() {
    return [
...
_c = TeamLeadersPage;
var _c;
__turbopack_context__.k.register(_c, "TeamLeadersPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=WEB-BASED_Frontend_610efc3c._.js.map