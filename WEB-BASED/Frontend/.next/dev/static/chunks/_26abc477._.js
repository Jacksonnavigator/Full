...
const useDataStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        fetchDMAs: async (utilityId)=>{
            try {
                const url = utilityId ? `/api/dmas?utilityId=${utilityId}` : "/api/dmas";
                const response = await fetch(url);
                if (!response.ok) throw new Error("Failed to fetch DMAs");
                const dmas = await response.json();
                set({
                    dmas
                });
            } catch (error) {
        ...
        fetchEngineers: async (dmaId)=>{
            try {
                const url = dmaId ? `/api/engineers?dmaId=${dmaId}` : "/api/engineers";
                const response = await fetch(url);
        ...
        fetchTeams: async (dmaId)=>{
            try {
                const url = dmaId ? `/api/teams?dmaId=${dmaId}` : "/api/teams";
                const response = await fetch(url);
        ...
        addDMA: async (data)=>{
            try {
                ...
                if (!response.ok) {
                    ...
                    throw new Error(errorData.error || "Failed to create DMA");
                }
                await get().fetchDMAs();
            } catch (error) {
        ...
        updateDMA: async (id, data)=>{
            try {
                const response = await fetch(`/api/dmas/${id}`, {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json"
                    },
                ...
                if (!response.ok) {
                    const errorData = await response.json();
                    throw new Error(errorData.error || "Failed to update DMA");
                }
                await get().fetchDMAs();
            } catch (error) {
        ...
        deleteDMA: async (id)=>{
            try {
                ...
                if (!response.ok) {
                    const errorData = await response.json();
                    throw new Error(errorData.error || "Failed to delete DMA");
                }
                await get().fetchDMAs();
            } catch (error) {
...
//# sourceMappingURL=_26abc477._.js.map