...
function AppSidebar() {
    ...
    const visibleItems = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NAV_ITEMS"].filter((item)=>item.roles.includes(currentUser.role));
