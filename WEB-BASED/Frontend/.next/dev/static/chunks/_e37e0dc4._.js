...
function DMAManagersPage() {
    ...
    async function handleSubmit() {
        ...
        if (!editingManager && !formPassword.trim()) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Password is required for new managers");
            return;
        }
        ...
        try {
            if (editingManager) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("DMA Manager created successfully");
            }
            setDialogOpen(false);
        } catch (error) {
...
_s(DMAManagersPage, "3l4kMWR4ovlf4V6g4lVdhGkWbQc=", false, function() {
    return [
...
//# sourceMappingURL=_e37e0dc4._.js.map