...
"[project]/app/(dashboard)/_views/analytics-page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AnalyticsPage() {
    ...
    const { utilities, dmas, reports, fetchReportsForMap } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$data$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDataStore"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AnalyticsPage.useEffect": ()=>{
            async function loadReports() {
                ...
                setLoading(true);
                try {
                    await fetchReportsForMap(isUtility ? {
    ...
    const visibleUtilities = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[visibleUtilities]": ()=>{
            if (isAdmin) return utilities;
            return utilities.filter({
                "AnalyticsPage.useMemo[visibleUtilities]": (utility)=>utility.id === currentUser?.utilityId
            }["AnalyticsPage.useMemo[visibleUtilities]"]);
        }
    }["AnalyticsPage.useMemo[visibleUtilities]"], [
        currentUser?.utilityId,
    ...
    const visibleDMAs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[visibleDMAs]": ()=>{
            const base = isAdmin ? dmas : dmas.filter({
                "AnalyticsPage.useMemo[visibleDMAs]": (dma)=>dma.utilityId === currentUser?.utilityId
            }["AnalyticsPage.useMemo[visibleDMAs]"]);
            if (selectedUtilityId === "all") return base;
            return base.filter({
                "AnalyticsPage.useMemo[visibleDMAs]": (dma)=>dma.utilityId === selectedUtilityId
            }["AnalyticsPage.useMemo[visibleDMAs]"]);
        }
    }["AnalyticsPage.useMemo[visibleDMAs]"], [
        currentUser?.utilityId,
        ...
        "AnalyticsPage.useMemo[scopedReports]": ()=>{
            ...
            if (isUtility && currentUser?.utilityId) {
                return reports.filter({
                    "AnalyticsPage.useMemo[scopedReports]": (report)=>report.utilityId === currentUser.utilityId
                }["AnalyticsPage.useMemo[scopedReports]"]);
            }
            return [];
        }
    ...
    const filteredReports = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[filteredReports]": ()=>{
            return scopedReports.filter({
                "AnalyticsPage.useMemo[filteredReports]": (report)=>{
    ...
    const statusChartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[statusChartData]": ()=>{
            const counts = new Map();
            filteredReports.forEach({
                "AnalyticsPage.useMemo[statusChartData]": (report)=>{
                    counts.set(report.status, (counts.get(report.status) ?? 0) + 1);
                }
            }["AnalyticsPage.useMemo[statusChartData]"]);
            return Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["REPORT_STATUS_CONFIG"]).map({
                "AnalyticsPage.useMemo[statusChartData]": (status)=>({
                        name: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["REPORT_STATUS_CONFIG"][status].label,
                        count: counts.get(status) ?? 0
                    })
            }["AnalyticsPage.useMemo[statusChartData]"]).filter({
                "AnalyticsPage.useMemo[statusChartData]": (item)=>item.count > 0
            }["AnalyticsPage.useMemo[statusChartData]"]);
        }
    }["AnalyticsPage.useMemo[statusChartData]"], [
        filteredReports
    ]);
    const priorityChartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[priorityChartData]": ()=>{
            const counts = new Map();
            filteredReports.forEach({
                "AnalyticsPage.useMemo[priorityChartData]": (report)=>{
                    counts.set(report.priority, (counts.get(report.priority) ?? 0) + 1);
                }
            }["AnalyticsPage.useMemo[priorityChartData]"]);
            return Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRIORITY_CONFIG"]).map({
                "AnalyticsPage.useMemo[priorityChartData]": (priority)=>({
                        name: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRIORITY_CONFIG"][priority].label,
                        count: counts.get(priority) ?? 0
                    })
            }["AnalyticsPage.useMemo[priorityChartData]"]).filter({
                "AnalyticsPage.useMemo[priorityChartData]": (item)=>item.count > 0
            }["AnalyticsPage.useMemo[priorityChartData]"]);
        }
    }["AnalyticsPage.useMemo[priorityChartData]"], [
        filteredReports
    ]);
    const leakageTypeChartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[leakageTypeChartData]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$report$2d$metrics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["computeLeakageTypeDistribution"])(filteredReports)
    ...
    const utilityChartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[utilityChartData]": ()=>{
            ...
            return visibleUtilities.map({
                "AnalyticsPage.useMemo[utilityChartData]": (utility)=>({
                        name: utility.name.length > 18 ? `${utility.name.slice(0, 18)}…` : utility.name,
                        count: filteredReports.filter({
                            "AnalyticsPage.useMemo[utilityChartData]": (report)=>report.utilityId === utility.id
                        }["AnalyticsPage.useMemo[utilityChartData]"]).length
                    })
            }["AnalyticsPage.useMemo[utilityChartData]"]).filter({
                "AnalyticsPage.useMemo[utilityChartData]": (item)=>item.count > 0
            }["AnalyticsPage.useMemo[utilityChartData]"]).sort({
                "AnalyticsPage.useMemo[utilityChartData]": (left, right)=>right.count - left.count
            }["AnalyticsPage.useMemo[utilityChartData]"]);
        }
    }["AnalyticsPage.useMemo[utilityChartData]"], [
        filteredReports,
    ...
    const dmaChartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[dmaChartData]": ()=>{
            return visibleDMAs.map({
                "AnalyticsPage.useMemo[dmaChartData]": (dma)=>({
                        name: dma.name.length > 20 ? `${dma.name.slice(0, 20)}…` : dma.name,
                        count: filteredReports.filter({
                            "AnalyticsPage.useMemo[dmaChartData]": (report)=>report.dmaId === dma.id
                        }["AnalyticsPage.useMemo[dmaChartData]"]).length
                    })
            }["AnalyticsPage.useMemo[dmaChartData]"]).filter({
                "AnalyticsPage.useMemo[dmaChartData]": (item)=>item.count > 0
            }["AnalyticsPage.useMemo[dmaChartData]"]).sort({
                "AnalyticsPage.useMemo[dmaChartData]": (left, right)=>right.count - left.count
            }["AnalyticsPage.useMemo[dmaChartData]"]).slice(0, 12);
        }
    }["AnalyticsPage.useMemo[dmaChartData]"], [
        filteredReports,
        visibleDMAs
    ]);
    const monthlyTrendData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[monthlyTrendData]": ()=>{
            const now = new Date();
            const buckets = Array.from({
                length: 12
            }, {
                "AnalyticsPage.useMemo[monthlyTrendData].buckets": (_, index)=>{
            ...
            }["AnalyticsPage.useMemo[monthlyTrendData].buckets"]);
            const bucketMap = new Map(buckets.map({
                "AnalyticsPage.useMemo[monthlyTrendData]": (bucket)=>[
                        bucket.key,
                        bucket
                    ]
            }["AnalyticsPage.useMemo[monthlyTrendData]"]));
            filteredReports.forEach({
                "AnalyticsPage.useMemo[monthlyTrendData]": (report)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "grid gap-2 md:grid-cols-3 xl:max-w-2xl",
                        children: [
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: leakageTypeChartData.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: leakageTypeChartData.map((row)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_b9753fc8._.js.map