...
function OperationsDashboard() {
    ...
    const visibleDMAs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OperationsDashboard.useMemo[visibleDMAs]": ()=>{
            ...
            return base.filter({
                "OperationsDashboard.useMemo[visibleDMAs]": (dma)=>dma.utilityId === selectedUtilityId
            }["OperationsDashboard.useMemo[visibleDMAs]"]);
        }
    }["OperationsDashboard.useMemo[visibleDMAs]"], [
        currentUser?.dmaId,
    ...
    const comparisonRows = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OperationsDashboard.useMemo[comparisonRows]": ()=>{
            const isResolved = {
                "OperationsDashboard.useMemo[comparisonRows].isResolved": (status)=>status === "approved" || status === "closed"
            }["OperationsDashboard.useMemo[comparisonRows].isResolved"];
            if (isAdmin) {
                const rows = new Map();
                utilities.forEach({
            ...
            if (isUtility && currentUser?.utilityId) {
                const rows = new Map();
                dmas.filter({
                    "OperationsDashboard.useMemo[comparisonRows]": (dma)=>dma.utilityId === currentUser.utilityId
                }["OperationsDashboard.useMemo[comparisonRows]"]).forEach({
                ...
                return [
                    {
                        ...
                        resolved: scopedReports.filter({
                            "OperationsDashboard.useMemo[comparisonRows]": (report)=>isResolved(report.status)
    ...
    const mapCenter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OperationsDashboard.useMemo[mapCenter]": ()=>{
            ...
            if (mapReports.length) {
                const lat = mapReports.reduce({
                    "OperationsDashboard.useMemo[mapCenter]": (sum, report)=>sum + report.latitude
                }["OperationsDashboard.useMemo[mapCenter]"], 0) / mapReports.length;
                const lng = mapReports.reduce({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OperationsDashboard.useEffect": ()=>{
            ...
            }["OperationsDashboard.useEffect"]) ? filters : undefined).finally({
                "OperationsDashboard.useEffect": ()=>setLoading(false)
            }["OperationsDashboard.useEffect"]);
        }
    }["OperationsDashboard.useEffect"], [
        fetchReportsForMap,
