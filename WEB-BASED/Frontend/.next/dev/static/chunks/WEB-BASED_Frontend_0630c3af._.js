...
"[project]/WEB-BASED/Frontend/app/(dashboard)/utilities/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UtilitiesPage() {
    ...
    const { utilities, dmas, fetchUtilities, fetchDMAs, addUtility, updateUtility } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$store$2f$data$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDataStore"])();
    ...
    const [editingUtility, setEditingUtility] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [utilityManagers, setUtilityManagers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    // Form state
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$components$2f$shared$2f$page$2d$header$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PageHeader"], {
                    ...
                    fileName: "[project]/WEB-BASED/Frontend/app/(dashboard)/utilities/page.tsx",
                    lineNumber: 108,
                    columnNumber: 9
                }, this),
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "Only Admins can manage utilities"
                                        }, void 0, false, {
                                            fileName: "[project]/WEB-BASED/Frontend/app/(dashboard)/utilities/page.tsx",
                                            lineNumber: 120,
                                            columnNumber: 17
    ...
    async function handleSubmit() {
        if (!formName.trim()) {
            __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Utility name is required");
            return;
        }
        try {
            if (editingUtility) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Utility updated successfully");
            } else {
                await addUtility({
                    name: formName,
                    description: formDescription,
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Utility created successfully");
            }
            setDialogOpen(false);
        } catch  {
    ...
    async function handleDelete() {
        if (deleteId) {
            try {
                const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONFIG"].backend.fullUrl}/utilities/${deleteId}`, {
                    method: "DELETE"
                });
                const data = await response.json();
                if (!response.ok) {
                    if (data.message) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(data.message, {
                            duration: 5000
                        });
                    } else {
                        __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(data.error || "Failed to delete utility");
                    }
                    return;
                }
                __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Utility deleted successfully");
                setDeleteId(null);
                await fetchUtilities();
            } catch (error) {
                console.error("Error deleting utility:", error);
                __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to delete utility");
            }
        }
    }
    // Stats
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "Manage all utilities in the water infrastructure system"
                                    }, void 0, false, {
                                        fileName: "[project]/WEB-BASED/Frontend/app/(dashboard)/utilities/page.tsx",
                                        lineNumber: 231,
                                        columnNumber: 13
            ...
            filteredUtilities.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                className: "border-slate-200/60 shadow-lg shadow-slate-200/20",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                    className: "py-16 text-center",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: filteredUtilities.map((utility)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$WEB$2d$BASED$2f$Frontend$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("h-1", utility.status === "active" ? "bg-gradient-to-r from-cyan-400 via-blue-500 to-cyan-400" : "bg-gradient-to-r from-red-400 via-rose-500 to-red-400")
                            }, void 0, false, {
                                fileName: "[project]/WEB-BASED/Frontend/app/(dashboard)/utilities/page.tsx",
                                lineNumber: 341,
                                columnNumber: 15
...
_s(UtilitiesPage, "bTpSZHp+JHv1G4ETGm5AhNa0M9E=", false, function() {
    return [
...
//# sourceMappingURL=WEB-BASED_Frontend_0630c3af._.js.map